        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1 class="text-2xl font-bold mb-4">{{ isset($property) ? 'Modifier' : 'Ajouter' }} un bien immobilier</h1>
                    ...
                    <form action="{{ isset($property) ? route('properties.update', $property) : route('properties.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="area_m2" class="block text-gray-700 text-sm font-bold mb-2">Superficie (m²)</label>
                            <input type="number" name="area_m2" id="area_m2" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $property->area_m2 ?? old('area_m2') }}" required>
                        </div>

                        <div class="mb-4">
                            <label for="volume_m3" class="block text-gray-700 text-sm font-bold mb-2">Volume (m³)</label>
                            <input type="number" name="volume_m3" id="volume_m3" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $property->volume_m3 ?? old('volume_m3') }}" required>
                        </div>
